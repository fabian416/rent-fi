...
const CLIFF_DURATION = new anchor.BN(60 * 60 * 24 * 30 * 6); // for PROD const CLIFF_DURATION = new anchor.BN(3 * 30 * 24 * 60 * 60); // Cliff en segundos
...
(async () => {
  ...
  const beneficiaryPublicKey = new PublicKey("E3kn3jfEBzie3hxJn1C2nVUReHob9reyRYJWTqHZYXae"); // Cambia por la dirección real del beneficiario
